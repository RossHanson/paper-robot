...
public:
  ...
  void lookDown(double x, double y, double z)
  {
    printf("Received coords: %f %f %f",x,y,z);
...
int main(int argc, char** argv)
{
  ...
  printf("Coordinates: %s %s %s",x.c_str(),y.c_str(),z.c_str());
  RobotHead head;
  //head.shakeHead(3);
  head.lookDown(::atof(x.c_str()),::atof(y.c_str()),::atof(z.c_str()));
}
